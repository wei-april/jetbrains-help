...
public class CertificateContextHolder {
    ...
    public static void init() {
        ...
        rootKeyFile = FileUtils.getFileOrCreat(ROOT_KEY_FILE_NAME);
        if (!FileUtils.fileExists(PRIVATE_KEY_FILE_NAME)
                || !FileUtils.fileExists(PUBLIC_KEY_FILE_NAME)
            ...
            crtFile = FileUtils.getFileOrCreat(CET_FILE_NAME);
        }
